...
export class CS571HW9DbConnector {
    ...
    public constructor(config: CS571Config<HW9PublicConfig, HW9SecretConfig>) {
        this.config = config;
    ...
    public async createBadgerUser(user: BadgerUserRegistration): Promise<BadgerUser> {
        ...
        const hash = CS571HW9DbConnector.calculateHash(salt, user.pin);
